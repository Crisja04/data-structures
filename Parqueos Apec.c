...
int main () {
	...
	// Parqueo B
			 if (cantidad != 0 && cantidad <= disponibles[1] && disponibles[1] != 0) {
	...
	// Parqueo C 
				if (cantidad != 0 && cantidad <= disponibles[2] && disponibles[2] != 0) {
		...
		if (disponibles[0] == 0 && disponibles[1] == 0 && disponibles[2] == 0) {
